...
export const mockUpdates = [
  {
    ...
    meta_id: 'mock-1',
    setor_executor: 'Tecnologia da Informação',
    estimativa_cumprimento: 'Em Andamento',
  ...
  },
  {
    ...
    meta_id: 'mock-2',
    setor_executor: 'Recursos Humanos',
    estimativa_cumprimento: 'Totalmente Cumprido',
  ...
  },
  {
    ...
    meta_id: 'mock-3',
    setor_executor: 'Tecnologia da Informação',
    estimativa_cumprimento: 'Não Cumprido',
    link_evidencia: '',
  ...
  },
  {
    ...
    meta_id: 'mock-5',
    setor_executor: 'Comunicação Social',
    estimativa_cumprimento: 'Parcialmente Cumprido',
